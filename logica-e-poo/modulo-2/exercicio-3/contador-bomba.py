...
#
#Não é necessário, mas, caso deseje tornar o sistema mais realista para
#que o tempo realmente passe em segundos, você pode usar a função
#time.sleep() que existe na Python (acesse o link em anexo). No entanto,
